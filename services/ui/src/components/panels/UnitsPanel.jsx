...
/**
 * UnitsPanel — Unit list from PLC + edit form.
 * Extracted from App.jsx V3c.
 */
export default function UnitsPanel({
  ...
  units,
  selectedUnitId,
  unitBatchEdit, setUnitBatchEdit,
  unitLocationEdit, setUnitLocationEdit,
  unitStatusEdit, setUnitStatusEdit,
  unitTargetEdit, setUnitTargetEdit,
  unitSaving,
  handleUnitSelect, handleUnitSave,
}) {
  ...
  return (
    <DraggablePanel title="Units" onClose={onClose} width={880}>
          ...
          <div style={{ border: '1px solid #90caf9', borderRadius: 6, padding: 10, background: '#e3f2fd', display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
              <label style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: 12, width: 72 }}>
                Batch ID
                <input type="number" value={unitBatchEdit}
              ...
              <label style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: 12, width: 64 }}>
                Location
                <input type="text" inputMode="numeric" pattern="[0-9]*" value={unitLocationEdit}
              ...
              <button type="button" disabled={unitSaving} onClick={handleUnitSave}
