...
export default function CustomerPanel(props) {
  ...
  return (
    <DraggablePanel title="Customer" onClose={() => {
    ...
    minWidth: 350
      ...
      gap: 6
        ...
        gap: 8
          ...
          await api.post('/api/current-selection', {
          ...
          api.post('/api/current-selection', {
            customer: null,
            plant: null
        ...
        gap: 8
                      ...
                      <input type="text" value={newCustomerName} onChange={e => setNewCustomerName(e.target.value)} onKeyDown={async e => {
        ...
        }} placeholder="Customer name (Enter to save, Esc to cancel)" autoFocus style={{
          flex: 1,
          padding: 8,
          borderRadius: 4,
      ...
      gap: 6
        ...
        fontSize: 13
                    ...
                    {!creatingPlant ? <div style={{
        display: 'flex',
        gap: 8
      }}>
                        <select value={selectedPlant} onChange={e => setSelectedPlant(e.target.value)} style={{
          flex: 1,
          padding: 8,
          borderRadius: 4,
          border: '1px solid #ccc',
          fontSize: 13
                        ...
                        <button onClick={() => setCreatingPlant(true)} style={{
          padding: '8px 12px',
          borderRadius: 4,
          border: 'none',
          background: '#4caf50',
        ...
        gap: 8
                        ...
                        <input type="text" value={newPlantName} onChange={e => setNewPlantName(e.target.value)} onKeyDown={async e => {
          if (e.key === 'Enter' && newPlantName.trim()) {
            try {
              const data = await api.post(`/api/customers/${encodeURIComponent(selectedCustomer)}/plants`, {
        ...
        }} placeholder="Plant name (Enter to save, Esc to cancel)" autoFocus style={{
          flex: 1,
          padding: 8,
          borderRadius: 4,
          border: '1px solid #4caf50',
          ...
          fontSize: 13
                ...
                {selectedCustomer && selectedPlant && <div style={{
      display: 'grid',
      ...
      gap: 8
        ...
        gap: 4
          ...
          fontSize: 12
                      ...
                      <input type="text" value={simPurposeForm.country} onChange={e => setSimPurposeForm(prev => ({
          ...prev,
        ...
        gap: 4
          ...
          fontSize: 12
                      ...
                      <input type="text" value={simPurposeForm.city} onChange={e => setSimPurposeForm(prev => ({
          ...prev,
          city: e.target.value
          ...
          fontSize: 13
                ...
                {selectedCustomer && selectedPlant && plantStatus && !plantStatus.isConfigured && <div style={{
      display: 'flex',
      flexDirection: 'column',
      gap: 6
    }}>
        ...
        gap: 8
          ...
          fontSize: 13
                        ...
                        {plantSetups.map(t => <option key={t} value={t}>{t}</option>)}
                      </select>
                      <button onClick={async () => {
          if (!selectedTemplate) return;
          setCopyingTemplate(true);
          try {
            const data = await api.post(`/api/customers/${encodeURIComponent(selectedCustomer)}/plants/${encodeURIComponent(selectedPlant)}/copy-template`, {
        ...
        }} disabled={!selectedTemplate || copyingTemplate} style={{
          padding: '8px 12px',
          borderRadius: 4,
          border: 'none',
          ...
          fontSize: 13
                ...
                {selectedCustomer && selectedPlant && plantStatus && <div style={{
      padding: 12,
      ...
      marginTop: 8
        ...
        marginBottom: 4
                    ...
                    {plantStatus.isConfigured ? <div style={{
        color: '#2e7d32'
      }}>
